...
##### Leviia part
#The upper par is the nextcloud docker without VOLUME, NEXTCLOUD_VERSION and all about nextcloud.tar.bz2
...
RUN tar -xjf nextcloud.tar.bz2 --strip-components=1
RUN rm nextcloud.tar.bz2
RUN rm -rf "$GNUPGHOME" /var/www/html/updater
