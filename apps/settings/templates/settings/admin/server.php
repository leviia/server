...
<div class="section" id="backgroundjobs">
	...
	<p class="settings-hint" style="display: none;"><?php p($l->t('For the server to work properly, it\'s important to configure background jobs correctly. "Cron" is the recommended setting. Please see the documentation for more information.'));?></p>
	<form action="#">
		<fieldset>
